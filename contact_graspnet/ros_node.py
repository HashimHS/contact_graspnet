...
class GraspPlannerServer(object):
    ...
    def plan_grasp_handler(self, req):
        ...
        if n != 0:
            rospy.loginfo('Sorting the top {} grasps for each object'.format(self.n))
        ...
        #Save results
        rospy.loginfo("Saving the result...")
        result = dict()
        result['pred_grasps_cam'] = pred_grasps_cam
        result['scores'] = scores
        result['contact_pts'] = contact_pts
        result['pc_full'] = pc_full
